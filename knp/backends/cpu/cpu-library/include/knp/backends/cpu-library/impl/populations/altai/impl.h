...
inline void calculate_pre_impact_single_neuron_state_impl(
    knp::neuron_traits::neuron_parameters<STDPAltaiNeuron> &neuron)
{
    neuron.potential_ = std::round(neuron.potential_);
...
inline void impact_neuron_impl(
    knp::neuron_traits::neuron_parameters<STDPAltaiNeuron> &neuron, const knp::core::messaging::SynapticImpact &impact,
    bool is_forcing)
{
    impact_neuron_impl(static_cast<knp::neuron_traits::neuron_parameters<AltaiNeuron> &>(neuron), impact, is_forcing);
